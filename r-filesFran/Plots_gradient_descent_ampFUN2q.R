...
# '2494' does not compute the fit for some reason (EEG or source)
...
for (subid in 1:length(Subject_list)) {
  ...
  if (strcmp(Generate_EEG_plots, 'YES')) {
    ...
    if (!file.exists(paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Model_fit/EEG/ampFUN2q/",Subject, "_EEG_NA_NA.png",sep="")) || strcmp(Overwrite_plots, 'YES')){
