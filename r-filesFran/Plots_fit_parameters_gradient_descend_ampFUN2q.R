...
Header_mega_variable_param_v1 <-c('P0_1','P0_2','P0_3','P0_4','P0_5','P0_6','P0_7','Na_1','Na_2','Na_3','Na_4','Na_5','Na_6','Na_7',
                         'Pa_1','Pa_2','Pa_3','Pa_4','Pa_5','Pa_6','Pa_7','Nb_1','Nb_2','Nb_3','Nb_4','Nb_5','Nb_6','Nb_7',
                         'Pb_1','Pb_2','Pb_3','Pb_4','Pb_5','Pb_6','Pb_7','N1_1','N1_2','N1_3','N1_4','N1_5','N1_6','N1_7',
...
for (subid in 1:length(Subject_list)) {
  ...
  for (w in 1:length(Wave_list)) {
    ...
    if (file.exists(paste("/Volumes/EEGCyno/RES/ampOddClick/STPSP/STPSPFit",Subject, "22223344_5566_zm9999_all_DV_ampFUN_p2q",Subject,Parcel,Hemisphere,Wave,"gd.rda",sep="_"))){
      # Load the model fit variable
      load(paste("/Volumes/EEGCyno/RES/ampOddClick/STPSP/STPSPFit",Subject, "22223344_5566_zm9999_all_DV_ampFUN_p2q",Subject,Parcel,Hemisphere,Wave,"gd.rda",sep="_"))
      # Extract fit values
      ...
      Mega_variable_param_v1[[subid,pos_col+5]] <-  modelFit[['par']][6]
      Mega_variable_param_v1[[subid,pos_col+6]] <-  modelFit[['par']][7]
      ...
      Mega_variable_param_v2[[subid,w+35]] <-  modelFit[['par']][6]
      Mega_variable_param_v2[[subid,w+42]] <-  modelFit[['par']][7]
...
# Save variables
save(Mega_variable_param_v1, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN2q/EEG_Mega_variable_param_v1",sep=""))
save(Mega_variable_param_v2, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN2q/EEG_Mega_variable_param_v2",sep=""))
save(Mega_variable_corr, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN2q/EEG_Mega_variable_corr",sep=""))
...
val_long <- c()
pos_emp <- 0
Matrix_x <- matrix(unlist(Mega_variable_param_v1), ncol = 49)
for (subid in 1:length(Subject_list)) {
  for (i in 1:length(Header_mega_variable_param_v1)) {
