...
# Save variables
save(Mega_variable_param_v1, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/EEG_Mega_variable_param_v1",sep=""))
save(Mega_variable_param_v2, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/EEG_Mega_variable_param_v2",sep=""))
save(Mega_variable_corr, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/EEG_Mega_variable_corr",sep=""))
...
ggsave(
  ...
  plot = plot_heatmap,
  device = "png",
  path = "~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/",
  scale = 5,
  width = NA,
  height = NA,
  units = "cm",
...
for (parc in 1:length(Parcel_list)) {
  ...
  for (hem in 1:length(Hemisphere_list)) {
    ...
    save(Mega_variable_param_v1, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/",Parcel,"_",Hemisphere,"_Mega_variable_param_v1",sep=""))
    save(Mega_variable_param_v2, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/",Parcel,"_",Hemisphere,"_Mega_variable_param_v2",sep=""))
    save(Mega_variable_corr, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/",Parcel,"_",Hemisphere,"_Mega_variable_corr",sep=""))  
...
save(Mega_variable_ind_sub, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/Within_subjects/",Subject,"_Mega_variable",sep=""))  
# save(Mega_variable_ind_sub_corr, file = paste("~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/Within_subjects/",Subject,"_Mega_variable_corr",sep=""))  
...
if (1 == 1) { # Silly way to compress a long section
  ...
  ggsave(
    ...
    plot = plot_heatmap,
    device = "png",
    path = "~/Dropbox/ampOddClick/r-filesFran/Figures/Summary_parameters/ampFUN/Within_subjects/",
    scale = 5,
    width = NA,
    height = NA,
    units = "cm",
