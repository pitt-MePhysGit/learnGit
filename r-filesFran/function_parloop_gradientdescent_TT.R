...
function_parloop_gradientdescent_TT <- function(subid){
  ...
  for (w in 1:length(Wave_list)) {
    ...
    tst <- callSTPSP(tn, DVstr='DV', gd=T, show=FALSE, showCh=1,FUN=ampFUN,maxISI=10, minISI=0.2, maxp2p=5000, DVsdscale=5, 
